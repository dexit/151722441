...
class AdEdit extends ComponentBase
{
	...
	public function onRun() {
		$this->addJs('http://maps.googleapis.com/maps/api/js?sensor=false&libraries=places&language=vi');
		$this->addJs(CLF_ASSETS . '/vendor/jquery-geocomplete/jquery.geocomplete.js');
