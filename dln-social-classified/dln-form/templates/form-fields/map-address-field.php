<?php 
wp_enqueue_script( 'dln-jquery-map-js', DLN_CLF_PLUGIN_URL . '/3rd-party/jquery-ui-map/jquery.ui.map.js', array( 'jquery' ), '1.0.0', true );
wp_enqueue_script( 'dln-jquery-map-ext-js', DLN_CLF_PLUGIN_URL . '/3rd-party/jquery-ui-map/jquery.ui.map.extensions.js', array( 'jquery' ), '1.0.0', true );
?>
