...
class DLN_Job {
	...
	public function __construct() {
		// Define constants
		define( 'DLN_JOB_VERSION', '1.0.0' );
		define( 'DLN_JOB', 'dln-job' );
		define( 'DLN_JOB_PLUGIN_DIR', untrailingslashit( plugin_dir_path( __FILE__ ) ) );
		define( 'DLN_JOB_PLUGIN_URL', untrailingslashit( plugins_url( basename( plugin_dir_path( __FILE__ ) ), basename( __FILE__ ) ) ) );
