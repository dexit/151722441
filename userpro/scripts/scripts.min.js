...
jQuery(document).ready(function() {
	...
	/**
		Remove status
	**/
	jQuery('.userpro-bar-success i, .userpro-bar-failed i').live('click',function(){
	...
	/**
		Icons
	**/
	jQuery('.userpro-field').live('mouseenter',function(){
	...
	**/
	...
	/**
		toggle notice
	**/
	jQuery('a.userpro-alert-close').live('click',function(){
	...
	users list
	**/
	jQuery('.userpro-online-i').live('mouseenter',function(){
	...
	**/
	jQuery('.userpro-post:not(.userpro-post-compact)').live('mouseenter',function(){
	...
	jQuery('.userpro-alert-edit').live('click',function(){
	...
	/**
		save notice
	**/
	jQuery('.userpro-alert input[type=button]').live('click',function(){
	...
	**/
	jQuery('.userpro-social-facebook').live('click',function(){
		Login( jQuery(this) );
	});
	...
	/**
		...
		#, redirection, etc.
	**/
	jQuery("*[class^='popup-'], a[href='#']").live('click',function(e){
		e.preventDefault();
		return false;
	});
	...
	**/
	jQuery('.userpro-overlay, a.userpro-close-popup').live('click',function(e){
	...
	**/
	jQuery('.userpro form:not(.userpro-search-form)').live('submit',function(e){
		e.preventDefault();
		return false;
	});
	...
	**/
	jQuery('.userpro-user').live('mouseenter',function(){
	...
	**/
	jQuery('.userpro form:not(.userpro-search-form)').live('submit',function(){
	...
	**/
	jQuery('.userpro[data-template=register] input, .userpro[data-template=edit] input,  .userpro[data-template=change] input').live('blur',function(){
	...
	/**
		...
		required
	**/
	jQuery('.userpro[data-template=register] select').live('change',function(){
		var element = jQuery(this);
		var parent = element.parents('.userpro-input');
		var required = element.data('required');
		if (required == 1) {
	...
	/**
		...
		registration mode
	**/
	jQuery('.userpro[data-template=register] input[type=password][data-required=1]').live('keyup keydown',function(){
	...
	/**
		...
		edit mode
	**/
	jQuery('.userpro[data-template=edit] input[type=password]:first').live('keyup keydown',function(){
		userpro_password_strength_meter( jQuery(this) );
	});
	...
	**/
	jQuery('.userpro[data-template=change] input[type=password]:first').live('keyup keydown',function(){
		userpro_password_strength_meter( jQuery(this) );
	});
	...
	**/
	jQuery('.userpro-collapsible-1').live('click',function(){
	...
	**/
	jQuery("*[class^='popup-'],*[class^='popup-'] a").live('click',function(){
		var up_username = '';
		if (jQuery(this).data('up_username')) {
			up_username = jQuery(this).data('up_username');
		}
	...
	**/
	jQuery("input[name^='gender']").live('change',function(){
	...
	**/
	...
	/**
		cancel an upload
	**/
	jQuery('.userpro form:not(.userpro-search-form) .userpro-input .userpro-button.red').live('click',function(){
	...
	**/
	jQuery('.userpro input[type=radio]').live('click',function(){
	...
	**/
	jQuery('.userpro input[type=checkbox]').live('change',function(){
	...
	**/
	jQuery('.userpro-warning').live('click',function(){
