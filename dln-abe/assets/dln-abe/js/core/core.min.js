            ...
            return this.each(function() {
                function o(t) {
                    if (h) {
                        ...
                        e(o).closest("." + r.wrapperClass).is(x.parent()) && s(i, !0), t.preventDefault && !y && t.preventDefault(), y || (t.returnValue = !1)
                    }
                }
                ...
                function s(e, t, i) {
                    y = !1;
                    var o = e,
                        s = x.outerHeight() - R.outerHeight();
                    if (t && (o = parseInt(R.css("top")) + e * parseInt(r.wheelStep) / 100 * R.outerHeight(), o = Math.min(Math.max(o, 0), s), o = e > 0 ? Math.ceil(o) : Math.floor(o), R.css({
                        top: o + "px"
                        ...
                        a = Math.min(Math.max(a, 0), s), R.css({
                            top: a + "px"
                        })
                    }
                ...
                function n() {
                    if (l(), clearTimeout(p), v == ~~v) {
                        if (y = r.allowPageScroll, b != v) {
                            var e = 0 == ~~v ? "top" : "bottom";
                            x.trigger("slimscroll", e)
                        }
                    } else y = !1;
                    return b = v, f >= x.outerHeight() ? void(y = !0) : (R.stop(!0, !0).fadeIn("fast"), void(r.railVisible && E.stop(!0, !0).fadeIn("fast")))
                }

                function c() {
                    r.alwaysVisible || (p = setTimeout(function() {
                        r.disableFadeOut && h || u || d || (R.fadeOut("slow"), E.fadeOut("slow"))
                    }, 1e3))
                }
                ...
                if (x.parent().hasClass(r.wrapperClass)) {
                    var C = x.scrollTop();
                    if (R = x.parent().find("." + r.barClass), E = x.parent().find("." + r.railClass), l(), e.isPlainObject(i)) {
                        ...
                        if ("scrollTo" in i) C = parseInt(r.scrollTo);
                        else if ("scrollBy" in i) C += parseInt(r.scrollBy);
                        else if ("destroy" in i) return R.remove(), E.remove(), void x.unwrap();
                        s(C, !1, !0)
                    }
                } else {
                    r.height = "auto" == i.height ? x.parent().height() : i.height;
                    var S = e(w).addClass(r.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: r.width,
                        height: r.height
                    ...
                    var E = e(w).addClass(r.railClass).css({
                            width: r.size,
                            height: "100%",
                            position: "absolute",
                            top: 0,
                    ...
                    E.css(D), R.css(D), x.wrap(S), x.parent().append(R), x.parent().append(E), r.railDraggable && R.bind("mousedown", function(i) {
                        var o = e(document);
                        return d = !0, t = parseFloat(R.css("top")), pageY = i.pageY, o.bind("mousemove.slimscroll", function(e) {
                            currTop = t + e.pageY - pageY, R.css("top", currTop), s(0, R.position().top, !1)
                        ...
                        if (y || e.originalEvent.preventDefault(), e.originalEvent.touches.length) {
                            var t = (g - e.originalEvent.touches[0].pageY) / r.touchScrollStep;
                            s(t, !0), g = e.originalEvent.touches[0].pageY
                        }
                    }), l(), "bottom" === r.start ? (R.css({
                        top: x.outerHeight() - R.outerHeight()
                    }), s(0, !0)) : "top" !== r.start && (s(e(r.start).position().top, null, !0), r.alwaysVisible || R.hide()), a()
                }
            }), this
        }
    }), jQuery.fn.extend({
 ...
 * ======================================================================== */
! function(n) {
    "function" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : this.NProgress = n()
}(function() {
    function n(n, t, e) {
    ...
    function e(n, e, r) {
        ...
        return i = "translate3d" === c.positionUsing ? {
            transform: "translate3d(" + t(n) + "%,0,0)"
        } : "translate" === c.positionUsing ? {
            transform: "translate(" + t(n) + "%,0)"
        } : {
            "margin-left": t(n) + "%"
        }, i.transition = "all " + e + "ms " + r, i
    }

    function r(n, t) {
        var e = "string" == typeof n ? n : o(n);
    ...
    function i(n, t) {
        var e = o(n),
            i = e + t;
        r(e, t) || (n.className = i.substring(1))
    }

    function s(n, t) {
        var e, i = o(n);
        r(n, t) && (e = i.replace(" " + t + " ", " "), n.className = e.substring(1, e.length - 1))
    }
    ...
    u.configure = function(n) {
            var t, e;
            for (t in n) e = n[t], void 0 !== e && n.hasOwnProperty(t) && (c[t] = e);
            return this
        }, u.status = null, u.set = function(t) {
            var r = u.isStarted();
            t = n(t, c.minimum, 1), u.status = 1 === t ? null : t;
            var i = u.render(!r),
                s = i.querySelector(c.barSelector),
                o = c.speed,
                a = c.easing;
            return i.offsetWidth, l(function(n) {
                "" === c.positionUsing && (c.positionUsing = u.getPositioningCSS()), f(s, e(t, o, a)), 1 === t ? (f(i, {
                    transition: "none",
                    opacity: 1
            ...
            var e = u.status;
            return e ? ("number" != typeof t && (t = (1 - e) * n(Math.random() * e, .1, .95)), e = n(e + t, 0, .994), u.set(e)) : u.start()
        }, u.trickle = function() {
        ...
        function() {
            ...
            u.promise = function(e) {
                return e && "resolved" != e.state() ? (0 == t && u.start(), n++, t++, e.always(function() {
                    t--, 0 == t ? (n = 0, u.done()) : u.set((n - t) / n)
                }), this) : this
            }
        }(), u.render = function(n) {
            ...
            e.id = "nprogress", e.innerHTML = c.template;
            var r, s = e.querySelector(c.barSelector),
                o = n ? "-100" : t(u.status || 0);
            return f(s, {
                transition: "all 0 linear",
                transform: "translate3d(" + o + "%,0,0)"
            }), c.showSpinner || (r = e.querySelector(c.spinnerSelector), r && a(r)), document.body.appendChild(e), e
        }, u.remove = function() {
    ...
    var l = function() {
        ...
        f = function() {
            ...
            function t(n) {
                ...
                if (n in t) return n;
                for (var e, r = i.length, s = n.charAt(0).toUpperCase() + n.slice(1); r--;)
                    if (e = i[r] + s, e in t) return e;
                return n
            }

            function e(e) {
                return e = n(e), s[e] || (s[e] = t(e))
            }
            ...
            return function(n, t) {
                var e, i, s = arguments;
                if (2 == s.length)
                    for (e in t) i = t[e], void 0 !== i && t.hasOwnProperty(e) && r(n, e, i);
                else r(n, s[1], s[2])
            }
        }();
    return u
...
(function(a) {
    ...
    function o(x, w) {
        return RegExp.prototype.test.call(x, w)
    }

    function g(w) {
        return !o(j, w)
    }
    var k = Array.isArray || function(w) {
    ...
    function m(w) {
        return String(w).replace(/[&<>"'\/]/g, function(x) {
            return c[x]
        })
    }
    u.escape = m;
    ...
    t.prototype.scan = function(x) {
        var w = this.tail.match(x);
        if (w && w.index === 0) {
            this.tail = this.tail.substring(w[0].length);
            this.pos += w[0].length;
            return w[0]
        }
        return ""
    };
    t.prototype.scanUntil = function(x) {
        var w, y = this.tail.search(x);
        switch (y) {
            case -1:
                w = this.tail;
    ...
    r.make = function(w) {
        return (w instanceof r) ? w : new r(w)
    };
    r.prototype.clearCache = function() {
        this._cache = {}
    };
    r.prototype.push = function(w) {
        return new r(w, this)
    };
    r.prototype.lookup = function(w) {
        var z = this._cache[w];
        if (!z) {
            if (w === ".") {
                z = this.view
    ...
    p.prototype.compile = function(x, w) {
        return this._compile(this._cache, x, x, w)
    };
    p.prototype.compilePartial = function(x, y, w) {
        return this._compile(this._partialCache, x, y, w)
    };
    p.prototype.render = function(y, w, x) {
        return this.compile(y)(w, x)
    };
    p.prototype._compile = function(x, z, B, y) {
        if (!x[z]) {
            var C = u.parse(B, y);
            var A = e(C);
            var w = this;
            x[z] = function(D, F) {
                if (F) {
                    if (typeof F === "function") {
                        ...
                        for (var E in F) {
                            w.compilePartial(E, F[E])
                        }
                    }
                }
                return A(w, r.make(D), B)
            }
        }
        return x[z]
    };
    p.prototype._section = function(w, x, E, D) {
        var C = x.lookup(w);
        switch (typeof C) {
            case "object":
                if (k(C)) {
                    var y = "";
                    for (var z = 0, B = C.length; z < B; ++z) {
                        y += D(this, x.push(C[z]))
                    }
                    return y
                }
                return C ? D(this, x.push(C)) : "";
            case "function":
                var F = this;
                var A = function(G) {
                    return F.render(G, x)
                };
                return C.call(x.view, E, A) || "";
            default:
                if (C) {
                    return D(this, x)
                }
    ...
    p.prototype._inverted = function(w, x, z) {
        var y = x.lookup(w);
        if (!y || (k(y) && y.length === 0)) {
            return z(this, x)
        }
    ...
    p.prototype._partial = function(w, x) {
        if (!(w in this._partialCache) && this._loadPartial) {
            this.compilePartial(w, this._loadPartial(w))
        }
        var y = this._partialCache[w];
        return y ? y(x) : ""
    };
    p.prototype._name = function(w, x) {
        var y = x.lookup(w);
        if (typeof y === "function") {
            y = y.call(x.view)
        }
    ...
    p.prototype._escaped = function(w, x) {
        return u.escape(this._name(w, x))
    };
    ...
    function e(y) {
        ...
        function z(G, E, F) {
            ...
            for (var C = 0, A = y.length; C < A; ++C) {
                ...
                switch (D[0]) {
                    case "#":
                        H = F.slice.apply(F, i(D));
                        B += G._section(D[1], E, H, x(C, D[4], F));
                        break;
                    case "^":
                        B += G._inverted(D[1], E, x(C, D[4], F));
                        break;
                    case ">":
                        B += G._partial(D[1], E);
                        break;
    ...
    function v(B) {
        ...
        for (var x = 0; x < B.length; ++x) {
            ...
            switch (y[0]) {
                ...
                case "/":
                    if (C.length === 0) {
                        throw new Error("Unopened section: " + y[1])
                    }
                    z = C.pop();
                    if (z[1] !== y[1]) {
                        throw new Error("Unclosed section: " + z[1])
                    }
                    if (C.length > 0) {
                        A = C[C.length - 1][4]
                    } else {
    ...
    function q(w) {
        if (w.length !== 2) {
            throw new Error("Invalid tags: " + w.join(" "))
        }
        return [new RegExp(f(w[0]) + "\\s*"), new RegExp("\\s*" + f(w[1]))]
    }
    u.parse = function(I, K) {
        K = K || u.tags;
        var J = q(K);
        var z = new t(I);
        var G = [],
    ...
    u.compile = function(x, w) {
        return b.compile(x, w)
    };
    u.compilePartial = function(x, y, w) {
        return b.compilePartial(x, y, w)
    };
    u.render = function(y, w, x) {
        return b.render(y, w, x)
    };
    u.to_html = function(z, x, y, A) {
        var w = u.render(z, x, y);
...
! function(a, b) {
    ...
    function h(a) {
        return "undefined" == typeof this ? new h(a) : (this.opts = f(a || {}, h.defaults, n), void 0)
    }
...
! function(a) {
    function g(b) {
        ...
        try {
            ...
            return a(document).trigger("xmlParseError", [f]), void 0
        }
    }
    ...
    function i(b, c) {
        var d = !0;
        return "string" == typeof c ? a.isFunction(b.test) ? b.test(c) : b == c : (a.each(b, function(e) {
            return void 0 === c[e] ? d = !1 : (d = "object" == typeof c[e] && null !== c[e] ? d && i(b[e], c[e]) : b[e] && a.isFunction(b[e].test) ? d && b[e].test(c[e]) : d && b[e] == c[e], void 0)
        }), d)
    }
    ...
    function k(b, c) {
        ...
        if (a.isFunction(b.url.test)) {
            ...
            var d = b.url.indexOf("*");
            if (b.url !== c.url && -1 === d || !new RegExp(b.url.replace(/[-[\]{}()+?.,\\^$|#\s]/g, "\\$&").replace(/\*/g, ".+")).test(c.url)) return null
        }
        return b.data && c.data && !i(b.data, c.data) ? null : b && b.type && b.type.toLowerCase() != c.type.toLowerCase() ? null : b
    }
    ...
    function l(c, d, e) {
        ...
        c.proxy ? b({
            ...
            complete: function(a) {
                c.responseXML = a.responseXML, c.responseText = a.responseText, j(c, "status") && (c.status = a.status), j(c, "statusText") && (c.statusText = a.statusText), this.responseTimer = setTimeout(f, c.responseTime || 0)
            }
    ...
    function n(a, b, c) {
        if (o(a), a.dataType = "json", a.data && e.test(a.data) || e.test(a.url)) {
            q(a, b, c);
            var d = /^(\w+:)?\/\/([^\/?#]+)/,
                f = d.exec(a.url),
                g = f && (f[1] && f[1] !== location.protocol || f[2] !== location.host);
            if (a.dataType = "script", "GET" === a.type.toUpperCase() && g) {
                var h = p(a, b, c);
                return h ? h : !0
            }
        }
    ...
    function o(a) {
        "GET" === a.type.toUpperCase() ? e.test(a.url) || (a.url += (/\?/.test(a.url) ? "&" : "?") + (a.jsonp || "callback") + "=?") : a.data && e.test(a.data) || (a.data = (a.data ? a.data + "&" : "") + (a.jsonp || "callback") + "=?")
    }
    ...
    function q(a, b, c) {
        var d = c && c.context || a,
            g = a.jsonpCallback || "jsonp" + f++;
        a.data && (a.data = (a.data + "").replace(e, "=" + g + "$1")), a.url = a.url.replace(e, "=" + g + "$1"), window[g] = window[g] || function(c) {
            data = c, r(a, d, b), s(a, d, b), window[g] = void 0;
            try {
                delete window[g]
            } catch (e) {}
    ...
    function r(a, b, c) {
        a.success && a.success.call(b, c.responseText || "", status, {}), a.global && h(a, "ajaxSuccess", [{},
            a
        ])
    }

    function s(b, c) {
        b.complete && b.complete.call(c, {}, status), b.global && h("ajaxComplete", [{},
            b
    ...
    function t(e, f) {
        var g, h, i;
        "object" == typeof e ? (f = e, e = void 0) : f.url = e, h = a.extend(!0, {}, a.ajaxSettings, f);
        for (var j = 0; j < c.length; j++)
            if (c[j] && (i = k(c[j], h))) return d.push(h), a.mockjaxSettings.log(i, h), "jsonp" === h.dataType && (g = n(h, i, f)) ? g : (i.cache = h.cache, i.timeout = h.timeout, i.global = h.global, u(i, f), function(c, d, e, f) {
                g = b.call(a, a.extend(!0, {}, e, {
                    xhr: function() {
                        return m(c, d, e, f)
                    }
                }))
            }(i, h, f, c[j]), g);
        if (a.mockjaxSettings.throwUnmocked === !0) throw "AJAX not mocked: " + f.url;
        return b.apply(a, [f])
    }
    ...
    a.extend({
        ...
        1 == arguments.length ? c[a] = null : c = [], d = []
    }, a.mockjax.handler = function(a) {
        return 1 == arguments.length ? c[a] : void 0
...
! function(e, t, n, s) {
    function o(t, n) {
        this.element = t, this.settings = e.extend({}, d, n), this._defaults = d, this._name = a, this.init()
    }
    var a = "Core",
        i = !1,
        l = !1,
    ...
    o.prototype = {
        init: function() {
            this.MISC.Init(), this.PLUGINS(), this.VIEWPORTWATCH(), this.WINLOADER()
        },
        HELPER: {
            Console: function(t) {
                settings.console && e(element).on(t, function(e, n) {
                    console.log("----- " + t + " -----"), console.log(n.element)
                })
            }
        },
        WINLOADER: function() {
            element = this.element, settings = this.settings, settings.loader && (NProgress.start(), e(t).load(function() {
                NProgress.done()
            }))
        },
        VIEWPORTWATCH: function() {
            element = this.element, settings = this.settings, Response.action(function() {
                Response.band(settings.breakpoint.lg) && (l = !0, r = !1, c = !1, p = !1, i = !!e(element).hasClass("sidebar-minimized")), Response.band(settings.breakpoint.md, settings.breakpoint.lg - 1) && (l = !1, r = !0, c = !1, p = !1, i = !!e(element).hasClass("sidebar-minimized")), Response.band(settings.breakpoint.sm, settings.breakpoint.md - 1) && (l = !1, r = !1, c = !0, p = !1, i = !1), Response.band(0, settings.breakpoint.xs) && (l = !1, r = !1, c = !1, p = !0, i = !1)
            })
        },
        MISC: {
            Init: function() {
                this.ConsoleFix(), this.Scrollbar(".slimscroll"), this.Fastclick(), this.Unveil(), this.BsTooltip(), this.BsPopover(), this.Stellar(), this.InputPlaceholder()
            },
            ConsoleFix: function() {
                for (var e, n = function() {}, s = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], o = s.length, a = t.console = t.console || {}; o--;) e = s[o], a[e] || (a[e] = n)
            },
            Scrollbar: function(t) {
                e(".no-touch " + t).each(function(t, n) {
                    e(n).slimScroll({
                        size: "8px",
                        distance: "0px",
                        wrapperClass: e(n).data("wrapper") || "viewport",
            ...
            Unveil: function() {
                e("[data-toggle~=unveil]").unveil(200, function() {
        ...
        PLUGINS: function() {
            element = this.element, settings = this.settings,
                function() {
                    var t = "[data-toggle~=totop]";
                    e(element).on("click", t, function(t) {
                        e("html, body").animate({
                            scrollTop: 0
                ...
                function() {
                    var t = "[data-toggle~=waypoints]";
                    e(t).each(function() {
                        var t, n, s, o, a;
                        o = e(this).data("marker") ? e(this).data("marker") : this, s = e(this).data("offset") ? e(this).data("offset") : "80%", t = e(this).data("showanim") ? e(this).data("showanim") : "fadeIn", n = e(this).data("hideanim") ? e(this).data("hideanim") : !1, a = e(this).data("trigger-once") ? e(this).data("trigger-once") : !1, e(o).waypoint(function(s) {
                            "down" === s && e(this).removeClass(n + " animated").addClass(t + " animating").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                                e(this).removeClass("animating").addClass("animated").removeClass(t)
                            }), "up" === s && n !== !1 && e(this).removeClass(t + " animated").addClass(n + " animating").on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                                e(this).removeClass("animating").removeClass("animated").removeClass(n)
                            })
                        }, {
                            offset: s,
                            triggerOnce: a,
                ...
                function() {
                    function t(t, n) {
                        s = e(t).data("contextual") ? e(t).data("contextual") : "active", "checked" === n ? (e(t).parents(i).addClass(s), e(element).trigger(settings.eventPrefix + ".selectrow.selected", {
                            element: e(t).parents(i)
                        })) : (e(t).parents(i).removeClass(s), e(element).trigger(settings.eventPrefix + ".selectrow.unselected", {
                            element: e(t).parents(i)
                        }))
                    }
                    var s, a = "[data-toggle~=selectrow]",
                        i = e(a).data("target");
                    e(a).each(function() {
                        e(this).is(":checked") && t(this, "checked")
                    }), e(n).on("change", a, function() {
                        e(this).is(":checked") ? t(this, "checked") : t(this, "unchecked")
                    }), o.prototype.HELPER.Console(settings.eventPrefix + ".selectrow.selected"), o.prototype.HELPER.Console(settings.eventPrefix + ".selectrow.unselected")
                }(),
                function() {
                    function t(t) {
                        e(t).find("input[type=checkbox]").each(function() {
                            "selectrow" === e(this).data("toggle") && (e(this).is(":checked") || e(this).prop("checked", !0).trigger("change"))
                        }), e(element).trigger(settings.eventPrefix + ".checkall.checked", {
                            element: e(t)
                        })
                    }
                    ...
                    function s(t) {
                        e(t).find("input[type=checkbox]").each(function() {
                            "selectrow" === e(this).data("toggle") && e(this).is(":checked") && e(this).prop("checked", !1).trigger("change")
                        }), e(element).trigger(settings.eventPrefix + ".checkall.unchecked", {
                            element: e(t)
                        })
                    }
                    var a = "[data-toggle~=checkall]";
                    e(a).each(function() {
                        e(this).is(":checked") && t()
                    }), e(n).on("change", a, function() {
                        var n = e(this).data("target");
                        e(this).is(":checked") ? t(n) : s(n)
                    }), o.prototype.HELPER.Console(settings.eventPrefix + ".checkall.checked"), o.prototype.HELPER.Console(settings.eventPrefix + ".checkall.unchecked")
                }(),
                function() {
                    var t = !1,
                        n = "indicator",
                        s = "[data-toggle~=panelrefresh]";
                    e(element).on("click", s, function(s) {
                        var o = e(this).parents(".panel"),
                            a = o.find("." + n);
                        t = e(this).hasClass("demo") ? !0 : !1, 0 !== a.length ? (a.addClass("show"), t && setTimeout(function() {
                            a.removeClass("show")
                        }, 2e3), e(element).trigger(settings.eventPrefix + ".panelrefresh.refresh", {
                            element: e(o)
                        })) : e.error("There is no `indicator` element inside this panel."), s.preventDefault()
                    }), o.prototype.HELPER.Console(settings.eventPrefix + ".panelrefresh.refresh")
                }(),
                function() {
                    var t = "[data-toggle~=panelcollapse]";
                    e(element).on("click", t, function(t) {
                        function n(t) {
                            e(t).removeClass("down").addClass("up"), e(a).removeClass("pull").addClass("pulling").css("height", "0px").transition({
                                height: i
                            }, function() {
                                e(this).removeClass("pulling").addClass("pull out"), e(this).css({
                                    height: ""
                                })
                            }), e(element).trigger(settings.eventPrefix + ".panelcollapse.open", {
                                element: e(o)
                            })
                        }

                        function s(t) {
                            e(t).removeClass("up").addClass("down"), e(a).removeClass("pull out").addClass("pulling").css("height", i).transition({
                                height: "0px"
                            }, function() {
                                e(this).removeClass("pulling").addClass("pull"), e(this).css({
                                    height: ""
                                })
                            }), e(element).trigger(settings.eventPrefix + ".panelcollapse.close", {
                                element: e(o)
                            })
                        }
                        var o = e(this).parents(".panel"),
                            a = o.children(".panel-collapse"),
                            i = a.height();
                        0 === a.length && e.error("collapsable element need to be wrap inside '.panel-collapse'"), e(a).hasClass("out") ? s(this) : n(this), t.preventDefault()
                    }), o.prototype.HELPER.Console(settings.eventPrefix + ".panelcollapse.open"), o.prototype.HELPER.Console(settings.eventPrefix + ".panelcollapse.close")
                }(),
                function() {
                    var t, n, s = "[data-toggle~=panelremove]";
                    e(element).on("click", s, function(s) {
                        t = e(this).parents(".panel"), n = e(this).data("parent"), t.transition({
                            scale: 0
                        }, function() {
                            n ? e(this).parents(n).remove() : e(this).remove(), e(element).trigger(settings.eventPrefix + ".panelcollapse.remove", {
                                element: e(t)
                            })
                        }), s.preventDefault()
                    }), o.prototype.HELPER.Console(settings.eventPrefix + ".panelremove.remove")
                }(),
                function() {
                    function t(t) {
                        e(element).hasClass("sidebar-minimized") ? (i = !1, e(element).removeClass("sidebar-minimized"), e(this).removeClass("minimized"), e(element).trigger(settings.eventPrefix + ".sidebar.maximize", {
                            element: e(element)
                        })) : (i = !0, e(element).addClass("sidebar-minimized"), e(this).addClass("minimized"), e(element).trigger(settings.eventPrefix + ".sidebar.minimize", {
                            element: e(element)
                        })), t.preventDefault()
                    }
                    var n = "[data-toggle~=minimize]";
                    e(element).on("click", n, t), o.prototype.HELPER.Console(settings.eventPrefix + ".sidebar.minimize"), o.prototype.HELPER.Console(settings.eventPrefix + ".sidebar.maximize")
                }(),
                function() {
                    function t(t) {
                        var n = e(this),
                            s = n.data("parent"),
                            o = n.data("target");
                        "click" === t.type && (e(o).hasClass("in") ? (e(o).collapse("hide"), n.parent().removeClass("open")) : (s && e(s + " .in").each(function() {
                            e(this).collapse("hide"), e(this).parent().removeClass("open")
                        }), e(o).collapse("show"), n.parent().addClass("open"))), (c || i) && !!o == !0 && e(element).hasClass("touch") && "click" === t.type && (n.parent().hasClass("hover") ? (n.parent().removeClass("hover"), e(o).css("top", "")) : (s && e(s + " .hover").each(function(t, n) {
                            e(n).removeClass("hover")
                        }), n.parent().addClass("hover"), e(o)[0].getBoundingClientRect().bottom >= Response.viewportH() && e(o).css("top", "-" + (e(o)[0].getBoundingClientRect().bottom - Response.viewportH() + 2) + "px")))
                    }

                    function s(t) {
                        var n = e(this),
                            s = (n.children(a).data("parent"), n.children(a).data("target"));
                        (c || i) && !!s == !0 && (e(element).hasClass("touch") || ("mouseenter" === t.type && (n.addClass("hover"), e(s)[0].getBoundingClientRect().bottom >= Response.viewportH() && e(s).css("top", "-" + (e(s)[0].getBoundingClientRect().bottom - Response.viewportH() + 2) + "px")), "mouseleave" === t.type && (n.removeClass("hover"), e(s).css("top", ""))))
                    }
                    var o = "[data-toggle~=menu]",
                        a = "[data-toggle~=submenu]";
                    e(n).on("click", a, t).on("mouseenter mouseleave", o + " > li", s)
                }(),
                function() {
                    function t() {
                        return i = e(this).data("direction"), l = "ltr" === i ? ".sidebar-left" : ".sidebar-right", (i === !1 || "" === i) && e.error("missing `data-direction` value (ltr or rtl)"), e(element).hasClass(c + "-" + i) ? a() : s(), !1
                    }

                    function s() {
                        e(element).addClass(c + "-" + i), e(element).trigger(settings.eventPrefix + ".sidebar.open", {
                            element: e(l)
                        })
                    }

                    function a() {
                        e(element).hasClass(c + "-" + i) && (e(element).removeClass(c + "-" + i), e(element).trigger(settings.eventPrefix + ".sidebar.close", {
                            element: e(l)
                        }))
                    }
                    var i, l, r = "[data-toggle~=sidebar]",
                        c = "sidebar-open";
                    e(n).on("click", a).on("click", ".sidebar," + r, function(e) {
                        e.stopPropagation()
                    }).on("click", r, t), o.prototype.HELPER.Console(settings.eventPrefix + ".sidebar.open"), o.prototype.HELPER.Console(settings.eventPrefix + ".sidebar.close")
                }(),
                function() {
                    function t() {
                        function t() {
                            ...
                            if (e(n).hasClass("ladda-button")) var s = Ladda.create(n).start();
                            else e(n).prop("disabled", !0);
                            t.done(function(t) {
                                e(n).hasClass("ladda-button") ? s.stop() : e(n).prop("disabled", !1), e(element).trigger(settings.eventPrefix + ".formajax.done", {
                                    element: o,
                                    response: t
                                })
                            }), t.fail(function(t) {
                                e(n).hasClass("ladda-button") ? s.stop() : e(n).prop("disabled", !1), e(element).trigger(settings.eventPrefix + ".formajax.fail", {
                                    element: o,
                                    response: t
                                })
                            })
                        ...
                        var n = this,
                            o = e(this).parents(s),
                            i = o.data("options");
                        "object" != typeof i && a.push("`data-options` need to be a valid javascript object!"), i.validate && !jQuery().parsley && a.push("please include `parsley` plugin for form validation!"), a.length <= 0 ? i.validate === !0 ? o.parsley().validate() && t() : t() : e.each(a, function(t, n) {
                            e.error(n)
                        })
                    }
                    var s = "[data-toggle~=formajax]",
                        a = [];
                    e(n).on("submit", s, function(e) {
                        e.preventDefault()
                    }).on("click", s + " button[type=submit]", t), o.prototype.HELPER.Console(settings.eventPrefix + ".formajax.always"), o.prototype.HELPER.Console(settings.eventPrefix + ".formajax.done"), o.prototype.HELPER.Console(settings.eventPrefix + ".formajax.fail")
                }(), e(function() {
                    var t = "[data-toggle~=counterup]",
                        n = [];
                    e(t).each(function(t, s) {
                        options = e(s).data("options"), n.length <= 0 ? e(s).counterUp({
                            delay: 10,
                            time: 1e3
                    ...
                    var t = "[data-toggle~=offcanvas]",
                        n = [];
                    e(t).each(function(t, o) {
                        var a = e(o).data("options");
                        a !== s ? "object" != typeof a ? n.push("OffCanvas: `data-options` need to be a valid javascript object!") : (optOpenerClass = a.openerClass || "offcanvas-opener", optCloserClass = a.closerClass || "offcanvas-closer") : (optOpenerClass = "offcanvas-opener", optCloserClass = "offcanvas-closer"), n.length <= 0 ? e(o).on("click", "." + optOpenerClass, function(t) {
                            var n = e(this).hasClass("offcanvas-open-rtl") ? "offcanvas-open-rtl" : "offcanvas-open-ltr";
                            e(o).removeClass("offcanvas-open-ltr offcanvas-open-rtl").addClass(n), e(element).trigger(settings.eventPrefix + ".offcanvas.open", {
                                element: e(o)
                            }), t.preventDefault()
                        }).on("click", "." + optCloserClass, function(t) {
                            e(o).removeClass("offcanvas-open-ltr offcanvas-open-rtl"), e(element).trigger(settings.eventPrefix + ".offcanvas.close", {
                                element: e(o)
                            }), t.preventDefault()
                        }) : e.each(n, function(t, n) {
                            e.error(n)
                        })
                    }), o.prototype.HELPER.Console(settings.eventPrefix + ".offcanvas.open"), o.prototype.HELPER.Console(settings.eventPrefix + ".offcanvas.close")
                })
        }
    }, e.fn[a] = function(t) {
        return this.each(function() {
            e.data(this, a) || e.data(this, a, new o(this, t))
        })
    }
