...
<title><?php echo $page_title?$page_title.' ':'';?><?php echo $settings['seo_setting']['page_title'];?> -Powered by PinTuXiu</title>
...
<meta name="generator" content="PinTuXiu Basic V3.3" />
<meta name="author" content="PinTuXiu OnightJar Team" />
<meta name="copyright" content="2012-2013 OnightJar.com" />
		...
		<ul <?php echo ($userbar_need_scroll)?'class="scroll"':'';?>>
			...
			<li class="login menu" data-action="openLoginDialog" id="login_point">
         	...
         	<li class="profile menu">
				<a href="<?php echo spUrl("my","shares");?>" class="parent"><img src="<?php echo useravatar($current_user['user_id'], 'middle');?>" onerror="javascript:this.src = base_url + '/assets/img/avatar_middle.jpg';"/></a>
				<ul>
