...
class DLN_Common_Template {
	...
	public static function load_controller( $controller_name = '' ) {
		...
		$controller_file  = DLN_PRO_PLUGIN_DIR . '/controllers/controller-' . $controller_name . '.php';
	...
	public static function locate_template( $template_name, $template_path = '', $default_path = '' ) {
		...
		if ( ! $default_path )
			$default_path = DLN_PRO_PLUGIN_DIR . '/views/';
	...
	public static function load_frontend_assets() {
		...
		wp_enqueue_script( 'dln-app-js', DLN_PRO_PLUGIN_URL . '/assets/js/app.v1.js', array( 'jquery' ), DLN_PRO_VERSION, true );
		
		wp_enqueue_style( 'dln-app-css', DLN_PRO_PLUGIN_URL . '/assets/css/app.v1.css', null, DLN_PRO_VERSION );
	}
