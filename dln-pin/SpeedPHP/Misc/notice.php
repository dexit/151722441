...
?>
			<ul>
				<li><span><?php echo $trace["file"];?> on line <?php echo $trace["line"];?>
				</span></li>
			</ul>
			<div id="oneborder">
				<?php 
...
$start = $line - $GLOBALS['G_SP']["sp_error_show_source"];if ($start < 1) {
$start = 1;
}
$end = $line + $GLOBALS['G_SP']["sp_error_show_source"];if ($end > $count) {
$end = $count + 1;
}
$returns = array();
for ($i = $start; $i <= $end; $i++) {
