...
;(function( $, window, document, undefined ) {
    ...
    $(document).ready(function() {
        ...
        if( $.validator ) {
            ...
            /* Form Wizard */
            var v = $("#dln-wizard-form").validate({
                onsubmit: false
            });
            if ($.fn.mwsWizard) {
                $("#dln-wizard-form").mwsWizard({
                    forwardOnly: false,
