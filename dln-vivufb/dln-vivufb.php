...
class DLN_ViVuFB {
	...
	public function __construct() {
		// Define constants
		define( 'DLN_VVF_VERSION', '1.0.0' );
		define( 'DLN_VVF', 'dln-vivufb' );
		define( 'DLN_VVF_PLUGIN_DIR', untrailingslashit( plugin_dir_path( __FILE__ ) ) );
		define( 'DLN_VVF_PLUGIN_URL', untrailingslashit( plugins_url( basename( plugin_dir_path( __FILE__ ) ), basename( __FILE__ ) ) ) );
		
		// Define nonce ID
		define( 'DLN_VVF_NONCE', 'dln_vvf_nonce_check' );
	...
	public function requires() {
		include DLN_VVF_PLUGIN_DIR . '/common/shortcode.php';
		include DLN_VVF_PLUGIN_DIR . '/common/template.php';
		include DLN_VVF_PLUGIN_DIR . '/common/ajax.php';
		...
		//	if ( file_exists( DLN_VVF_PLUGIN_DIR . '/includes/dln-' . $component . '/dln-' . $component . '-loader.php' ) )
		//		include( DLN_VVF_PLUGIN_DIR . '/includes/dln-' . $component . '/dln-' . $component . '-loader.php' );
		//}
	}
...
$GLOBALS['dln_vivufb'] = new DLN_ViVuFB();
